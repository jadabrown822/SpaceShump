...
__1.__ Make changes to the _Hero_ C# script
  ...
  public class Hero: MonoBehaviour {
    ...
    */
    ...
    void OnTriggerEnter(Collider other) {
      ...
      Enemy enemy = go.GetComponent<Enemy>();
      PowerUp pUp = gp.GetComponent<PowerUp>();
      if (enemy != null) {    // If the shield was triggered by an enemy
        shieldLevel--;        // Decreases the level of the shield by 1
        Destroy(go);          // ... and Destroy the enemy
      }
...
### Making PowerUps Affect the Hero
__1.__ Open the Hero script and add code
  ...
  public class Hero: MonoBehaviour {
    ...
    */
    ...
    /*
      ...
      <returns>The first empty Weapon slot or null if not are empty</returns>
    */
...
__2.__ Also in Hero script fill the __switch__ block of the __AbsorbPowerUp()__ method
...
__5.__ Click _Play_. Run into  the PowerUp, it will swap those spread guns for a single blaster


# Race Conditions & Script Execution Order
__1.__ Add code to the __Awake()__ method of the _Hero_ script
...
__2.__ Save the Hero script in VS, return to Unity, and click _Play_

__3.__ From the main Unity menu, choose _Edit > Project Settings..._
> __a.__ On the left side of the Project Settings window, click _Script Execution Order_. This screen allows to choose the order in which specifics script execute
>
> __b.__ Click the __+__ in the bottom-right corner of the list of scripts and choose _Hero_ from the list. This places the __Hero__ class in the execution order stack at the bottom (a value of 100), which means that it is guaranteed to execute after all other scripts
>
> __c.__ Click the _field at the far right side of the __Hero__ strip_ in the stack and set its value to _-50_. This moces it just above Default Time in the stack, meaning that it will be called before most scripts
>
> __d.__ Click the _Apply_ button to set this as the Script Execution Order and then _close_ the Project Setting window
>
> __e.__ Now click _Play_, this will guarantee that the error can be seen

__4.__ From the main Unity menu, choose _Edit > Project Settings..._
> __a.__ On the left side of the Project Settings window, click _Script Execution Order_
>
> __b.__ click the __+__ in the bottom-right corner of the list of scripts and choose _Main_ from the list. This plaves __Main__ in the execution order stack at the bottom (a value of 100)
>
> __c.__ click the _field at the far right side of the __Main__ strip_ in the stack and set its value to _-75_. This moves it just above __Hero__ in the stack
>
